...
class LOOP_FIX11(Feature):
    ...
    def update_lag_time_feats(self,user_id,timestamp,
        ...
        if len(features_dicts['lag_user_time'][user_id]) == 0:
            features_dicts['lag_time_1_max'][user_id] = 0
        elif len(features_dicts['lag_user_time'][user_id]) == 1:
            lag_time = timestamp - features_dicts['lag_user_time'][user_id][0]
            features_dicts['lag_time_1_max'][user_id] = lag_time

        elif len(features_dicts['lag_user_time'][user_id]) == 2:
            lag_time = timestamp - features_dicts['lag_user_time'][user_id][1]
            if lag_time > features_dicts['lag_time_1_max'][user_id]:
                features_dicts['lag_time_1_max'][user_id] = lag_time

        elif len(features_dicts['lag_user_time'][user_id]) == 3:
            lag_time = timestamp - features_dicts['lag_user_time'][user_id][2]
            if lag_time > features_dicts['lag_time_1_max'][user_id]:
                features_dicts['lag_time_1_max'][user_id] = lag_time
    ...
    def create_lag_time_feats(self,num,user_id,timestamp,
        ...
        # TODO max
        if features_dicts['lag_time_1_max'][user_id] == 0:
            feats_np_dic['lag_time_1_max'][num] = np.nan
        else:
            feats_np_dic['lag_time_1_max'][num] = features_dicts['lag_time_1_max'][user_id]
    ...
    def create_features(self):
        ...
        with open(f'./features/all_data/loop_feats11.dill','wb') as f:
...
class ROLLING_MEAN3(Feature):
    ...
    def create_features(self):
        ...
        with open(f'./features/all_data/loop_feats_rolling_mean3.dill','wb') as f:
            dill.dump(features_dicts,f)




class ROLLING_PART_MEAN4(Feature):
    ...
    def create_datas(self,df):
        df_name_float_list = [
                    ...
                    'rolling_part_mean_3',
                    'rolling_part_mean_5',
                    'rolling_part_mean_15',
                    'rolling_part_mean_20'
        ]
    ...
    def create_dics(self):
        ...
        str_name = [
                    ...
                    'user_past_part_ans_5',
                    'user_past_part_ans_15',
                    'user_past_part_ans_20'
        ]
    ...
    def create_features(self):
        ...
        with open(f'./features/all_data/loop_feats_rolling_part_mean4.dill','wb') as f:
            dill.dump(features_dicts,f)
