...
SEED = 123
FEATURES_LIST = ['BASE_FIX','LOOP_FIX_TIME5','TAGS','GROUP_BY','BUNDLE_ID','ROLLING_MEAN3','ROLLING_PART_MEAN4','CONTENT_ID','TAGS_MEAN']
...
USE_COLS = ['prior_question_elapsed_time', 'prior_question_had_explanation', 'part','timestamp',
            ...
            'rolling_mean_3','rolling_mean_5','rolling_mean_10','rolling_mean_15','rolling_mean_20',
            'rolling_part_mean_3','rolling_part_mean_5','rolling_part_mean_10','rolling_part_mean_15','rolling_part_mean_20',
...
# USE_COLS = USE_COLS + tags_mean_name + tags_elapsed_time + tags_explanation_name
