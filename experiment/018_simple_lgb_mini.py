...
USE_COLS = ['answered_correctly_avg_user','prior_question_elapsed_time','prior_question_had_explanation','bundle_id','part','tags1','tags2','tags3','l_type_of','content_id',\
            'answered_correctly_sum_user','task_container_id','count_user','answered_correctly_avg_part','answered_correctly_avg_user_part','answered_correctly_sum_user_part','count_user_part',\
