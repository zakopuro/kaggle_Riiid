...
SEED = 123
FEATURES_LIST = ['BASE_FIX','LOOP_FIX4','TAGS','GROUP_BY','BUNDLE_ID','ROLLING_MEAN2','ROLLING_PART_MEAN2']
...
USE_COLS = ['prior_question_elapsed_time', 'prior_question_had_explanation', 'part',
            ...
            "tags_pca_0", "tags_pca_1",'tags1','tags2','tags3','tags_nan_count','tags_nan_count_mean','tags1_cut_mean','tags1_cut','tags_lsi',
            'first_bundle',
