...
SEED = 123
FEATURES_LIST = ['BASE_FIX','LOOP_FIX_TIME4','TAGS','GROUP_BY','BUNDLE_ID','ROLLING_MEAN2','ROLLING_PART_MEAN3','TIME']
...
USE_COLS = ['prior_question_elapsed_time', 'prior_question_had_explanation', 'part','timestamp',
            ...
            "tags_pca_0", "tags_pca_1",'tags1','tags2','tags_nan_count','tags_nan_count_mean','tags1_cut_mean',
            'first_bundle',
            'ans_part_mean','ans_user_part_avg','user_part_count',
            'ans_community_mean',
            'content_id','bundle_id',
            'first_bundle_cut','first_bundle_cut_mean',
            'rolling_mean_10','rolling_part_mean_10','todays_qs_count']
