...
FEATURES_LIST = ['BASE','USER_ID','CONTENT','BUNDLE','TASK_CONTAINER','PART','TAGS1','TIME','USER_ID_LECTURE','CROSS_FEATURES']

USE_COLS = ['prior_question_elapsed_time','prior_question_had_explanation','part','tags1','tags2','tags3','l_type_of','task_container_id','small_quenstion',\
            'answered_correctly_avg_user','answered_correctly_sum_user','count_user',
            'answered_correctly_avg_content_cut','answered_correctly_sum_content_cut','answered_correctly_std_content_cut','content_cut_num','content_id_cut',\
            'answered_correctly_avg_bundle_cut','answered_correctly_sum_bundle_cut','answered_correctly_std_bundle_cut','bundle_cut_num','bundle_id_cut',\
            ...
            'answered_correctly_avg_user_content_cut','answered_correctly_avg_user_bundle_cut','answered_correctly_avg_user_part','answered_correctly_avg_user_tags1',\
            'answered_correctly_avg_content_cut_part','answered_correctly_avg_bundle_cut_part']

TARGET = 'answered_correctly'

CAT_FEATURES = ['part','tags1','tags2','tags3','content_id_cut','task_container_id','prior_question_had_explanation',\
                'bundle_id_cut']
