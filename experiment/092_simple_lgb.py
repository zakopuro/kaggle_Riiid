...
SEED = 123
FEATURES_LIST = ['BASE_FIX','LOOP_FIX_TIME5','TAGS','GROUP_BY','BUNDLE_ID','ROLLING_MEAN2','ROLLING_PART_MEAN3','CONTENT_ID']
...
QS = [f'tag_{int(i)}' for i in range(188)]

USE_COLS = USE_COLS + QS
