...
SEED = 123
FEATURES_LIST = ['BASE_FIX','LOOP_FIX','TAGS','GROUP_BY']
...
USE_COLS = ['prior_question_elapsed_time', 'prior_question_had_explanation', 'part',
            'ans_user_avg', 'ans_user_count','elapsed_time_user_avg', 'explanation_user_avg',
            'ans_content_avg', 'elapsed_time_content_avg', 'explanation_content_avg',
            'user_content_count','user_bundle_count',
            'lag_time_1', 'lag_time_2', 'lag_time_3','lag_incorrect_time',
            ...
            'ans_community_mean','ans_user_community_avg','user_community_count','community',
            'part_community','ans_part_community_mean','ans_user_part_community_avg','user_part_community_count']
...
CAT_FEATURES = ['part','community','part_community']
